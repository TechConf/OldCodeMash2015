...
SUN_JAVA_HOME="/appl/java/jdk1.7.0_51"
export SUN_JAVA_HOME

DEFAULT_SUN_JAVA_HOME="/appl/java/jdk1.7.0_51"
...
if [ "${VM_TYPE}" = "JRockit" ] ; then
	...
	if [ "${JAVA_VENDOR}" = "Sun" ] ; then
		...
		JAVA_VENDOR="Oracle"
		export JAVA_VENDOR
		JAVA_HOME="/appl/java/jdk1.7.0_51"
		export JAVA_HOME
		VM_TYPE="HotSpot"
		export VM_TYPE
	fi
...
LONG_DOMAIN_HOME="/appl/oracle/middleware/wls/wls12120/user_projects/domains/mydomain"
